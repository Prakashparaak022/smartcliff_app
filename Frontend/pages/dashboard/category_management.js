...
function CategoryManagement() {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      await axios.put(
        `https://smartcliff-app.onrender.com/categories/${editingCategoryId}`,
  ...
  const handleDeleteCategory = async (categoryId) => {
    try {
      await axios.delete(
        `https://smartcliff-app.onrender.com/categories/${categoryId}`
      );
      fetchCategories();
    } catch (error) {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      await axios.post("https://smartcliff-app.onrender.com/categories", {
      ...
      <NoSsr>
        ...
        <Container maxWidth="md" style={{ marginTop: "140px" }}>
          <h2 style={{ textAlign: "center" }}>
            Category<span style={{ color: "#ed4d01" }}> Management</span>
          </h2>
