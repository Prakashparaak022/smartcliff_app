...
function EnquiryManagement() {
  ...
  const deleteEnquiry = async (enquiryId) => {
    ...
    try {
      await axios.delete(
        `https://smartcliff-app.onrender.com/enquiry/${enquiryId}`
      );
        ...
        {error !== "" ? <h5>{error}</h5> : null} */}
          ...
          <Dialog
            ...
            <DialogTitle
              ...
              <span style={{ color: "#f2705a" }}>Enquiry</span> Details
            </DialogTitle>
            <DialogContent sx={{ width: "500px", padding: "20px" }}>
              {selectedEnquiry && (
                <div>
                  <p>
                    <strong>Name:</strong> {selectedEnquiry.e_name}
                  </p>
                  <p>
                    <strong>Email:</strong> {selectedEnquiry.e_email}
                  </p>
                  <p>
                    <strong>Phone No:</strong> {selectedEnquiry.e_phone_number}
                  </p>
                  <p>
