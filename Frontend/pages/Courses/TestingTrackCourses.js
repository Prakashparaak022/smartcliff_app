...
const TestingTrackCourses = () => {
  ...
  useEffect(() => {
    setCategory(
      courses.filter((course) => course.category === "Testing Track")
    );
  }, [courses]);
  ...
  return (
    <>
      <section>
        <TitleComponent
          title={<span style={{ color: "#000" }}>Testing Track</span>}
        />
...
export default TestingTrackCourses;
