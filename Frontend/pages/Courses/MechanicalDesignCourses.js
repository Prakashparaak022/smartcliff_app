...
const MechanicalDesignCourses = () => {
  ...
  useEffect(() => {
    setCategory(
      courses.filter((course) => course.category === "Mechanical Design")
    );
  }, [courses]);
  ...
  return (
    <>
      <section>
        <TitleComponent
          title={<span style={{ color: "#000" }}>Mechanical Design</span>}
        />
...
export default MechanicalDesignCourses;
